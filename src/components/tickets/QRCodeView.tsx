  ...
  return (
    <div className="bg-white rounded-2xl p-8 border-2 border-gray-200">
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold mb-2">Scan to Validate</h2>
      ...
      <div className="bg-gray-100 rounded-xl p-8 mb-6 flex items-center justify-center">
        <div
          ...
          className="w-64 h-64 bg-white border-4 border-gray-800 rounded-lg flex items-center justify-center relative"
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-white p-2 rounded">
              <QrCode className="w-8 h-8 text-brand" aria-hidden="true" />
            </div>
          </div>
        </div>
      </div>
